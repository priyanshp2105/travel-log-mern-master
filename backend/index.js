...
app.put("/edit-story/:id", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    travelStory.visitedLocation = visitedLocation; // Fixed typo here (was 'JisitedLocation')
    ...
    // Return the updated story and success message
...
//Filter travel story byy data range
